    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          children: [
            Padding(
              padding: EdgeInsets.fromLTRB(8, 150, 8, 10),
              child: Text(
                argumentos.titulo,
                style: TextStyle(
                  fontSize: 20,
